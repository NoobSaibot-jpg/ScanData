                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <p className="text-gray-600">04112 м.Київ вулиця Дегтярівська буд.62, корпус А</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <a href="tel:+380443000408" className="text-gray-600 hover:text-customGreen transition-colors">
                                            (044)300-04-08
                                        </a>
                                    </div>
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <a href="tel:+380442074332" className="text-gray-600 hover:text-customGreen transition-colors">
                                            (044)207-43-32
                                        </a>
                                    </div>
                                </div>
