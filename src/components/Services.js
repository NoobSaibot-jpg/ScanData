...
import shadowImg from '../images/frame-2-1.png';  // Импорт PNG картинки с тенью
                    ...
                    {[{
                        ...
                        >
                            <div className="relative overflow-hidden">
                                ...
                                />
                                {/* Цветное затемнение при наведении */}
                            ...
                            <div className="p-6 transform transition-all duration-300 group-hover:scale-105">
                                <h3 className="text-xl font-bold text-gray-800 mb-3 transition-all duration-300 group-hover:text-customGreen">{service.title}</h3>
                                <p className="text-gray-600 leading-relaxed transition-all duration-300 group-hover:text-gray-800">{service.text}</p>
                            </div>
                        </Link>
                    ))}
                </div>
